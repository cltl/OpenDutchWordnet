...
import http.server, json, threading, time, os, sys, sqlite3, hashlib, secrets
...
if __name__ == '__main__':
    ...
    # Auto-discover: prefer existing .db over .xml
    ...
    if db_file:
        ...
        existing = os.path.isfile(DB_PATH) and os.path.getsize(DB_PATH) > 4096
        if existing:
